...
export default function App() {
  ...
  if (view === "jobs" || view === "cvs") return <Navigate to="/app" replace />;
    ...
    <div className="checker-flow report-experience" data-ai-id="cv-match-workspace">
      <header className="checker-topbar report-topbar" data-ai-id="report-topbar">
        ...
        <nav className="report-mode-tabs" aria-label={"Ch\u1ebf \u0111\u1ed9 b\u00e1o c\u00e1o"}>
          ...
          <button type="button" className={view === "summary" ? "active" : ""} onClick={() => setView("summary")}><Icon name="users" size={18} /> {"T\u1ed5ng h\u1ee3p"}</button>
        </nav>
      ...
      <main className="workspace report-workspace" data-ai-id="main-workspace">
